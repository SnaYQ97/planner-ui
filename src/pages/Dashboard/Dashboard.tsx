...
import { getCategories as getCategoriesSelector } from "@selectors/category.selector.ts";
import { setUser, User } from "@reducer/user.reducer.ts";
import { setBankAccounts } from "@reducer/bankAccount.reducer.ts";
import { setCategories } from "@reducer/category.reducer.ts";
import { Chart as ChartJS, ArcElement, Tooltip } from 'chart.js';
import { useGetBankAccounts } from '@services/BankAccountService/BankAccount.service.ts';
import { useGetCategories, useDeleteCategory } from '@services/CategoryService/Category.service.ts';
import { Category } from '@types/category.ts';
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogDescription, DialogFooter } from "@components/ui/dialog.tsx";
import { AddCategoryForm } from '@components/AddCategoryForm/AddCategoryForm.tsx';
import { EditCategoryForm } from '@components/EditCategoryForm/EditCategoryForm.tsx';
import { UserHeader } from './components/UserHeader/UserHeader.tsx';
import { BudgetSummary } from './components/BudgetSummary/BudgetSummary.tsx';
import { CategoryList } from './components/CategoryList/CategoryList.tsx';
import { ExpenseSection } from './components/ExpenseSection/ExpenseSection.tsx';
import { IncomeSection } from './components/IncomeSection/IncomeSection.tsx';
import { Button } from "@components/ui/button.tsx";
import { SavingsAccountsSection } from './components/SavingsAccountsSection';
import { useGetTransactions } from '@services/TransactionService/Transaction.service.ts';
import { AddSavingsAccountForm } from "@components/AddSavingsAccountForm/AddSavingsAccountForm.tsx";
